...
BEGIN TRANSACTION;
INSERT INTO [EMain].[PLocRule]( Guid, [EquipmentKindId], [SourcePlacementLocationTypeId], [SourceOrganizationUnitId], [SourcePlacementLocationId], [CurrentPlacementLocationTypeId], [CurrentOrganizationUnitId], [CurrentPlacementLocationId], [TargetPlacementLocationTypeId], [TargetOrganizationUnitId], [TargetPlacementLocationId], [IsEnabled], [EmployeeOrganizationUnitId], [Name])
...
COMMIT;
RAISERROR (N'[EMain].[PLocRule]: Insert Batch: 1.....Done!', 10, 1) WITH NOWAIT;
GO
